...
export const routingComponents = [LoginComponent, DashboardComponent, DashboardComponent2, DashboardComponent3, NuevoComponent, EditarComponent, MainmenuComponent]
